...
export default class Resizable extends React.Component<Props, State> {
  ...
  runConstraints(newWidth: number, newHeight: number): [number, number] {
    ...
    if (this.props.lockAspectRatio) {
      ...
      if (height === this.state.height && width === this.state.width) {
        // Fix vertical resize with N/S handles on locked aspect ratio
        // Calculate the change height-first, instead of width-first
